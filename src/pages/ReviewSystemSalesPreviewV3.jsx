export default function ReviewSystemSalesPreviewV3() {
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            ...
            <div className="bg-purple-50 border-2 border-purple-300 rounded-lg p-6">
              ...
              <div className="bg-purple-100 border-2 border-purple-400 rounded-lg p-4 text-center">
                ...
                <p className="font-bold text-purple-700 text-2xl">Your Year 1 return: $647K-$1.3M+</p>
              </div>
            ...
            <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-6">
              ...
              <div className="bg-blue-100 border-2 border-blue-400 rounded-lg p-4 text-center">
                <p className="font-bold text-gray-900 text-lg">Your investment: $2,997</p>
                <p className="font-bold text-blue-700 text-2xl">Your Year 1 return: $132K-$272K+</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-primary-700 to-primary-900 text-white rounded-lg shadow-xl p-8 mb-8">
          <div className="text-center">
            ...
            <div className="bg-primary-800 rounded-lg p-6 mb-8 max-w-3xl mx-auto">
              ...
              <ol className="text-left space-y-3 text-primary-100">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-white">I'll recommend</strong> which package fits your situation (Complete System, Accelerated, or VIP)</span>
                </li>
                <li className="flex items-start gap-3">
            ...
            <div className="border-t-2 border-primary-600 pt-6 max-w-2xl mx-auto">
              <p className="text-primary-100 mb-4 italic">Or, if you're ready to get started immediately, purchase the Complete System package below.</p>
              <a
                href="mailto:matt@mattshelton.co?subject=Purchase Complete System Package - Review System ($2,997 Founding Member Rate)"
